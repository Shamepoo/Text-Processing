...
def readFiles(sentimentDictionary,sentencesTrain,sentencesTest,sentencesNokia):
    ...
    #        posWordList.remove(word)
    #for word in negWordList:
    #    if word in repeatWords:
    #        negWordList.remove(word)
...
def testBayes(sentencesTest, dataName, pWordPos, pWordNeg, pWord,pPos):
    ...
    return correct, total, correctpos, totalpospred, totalpos, correctneg, totalnegpred, totalneg
...
def BayesRes(correct, total, correctpos, totalpospred, totalpos, correctneg, totalnegpred, totalneg):
    Accuracy = correct/total
    print("Accuracy is: ", Accuracy)
    PrecisionPos = correctpos/totalpospred
    print("PrecisionPos is: ", PrecisionPos)
    RecallPos = correctpos/totalpos
    print("RecallPos is: ", RecallPos)
    PrecisionNeg = correctneg/totalnegpred
    print("PrecisionNeg is: ", PrecisionNeg)
    RecallNeg = correctneg/totalneg
    print("RecallNeg is: ", RecallNeg)
    F1Pos = (2 * PrecisionPos * RecallPos)/(PrecisionPos + RecallPos)
    print("F1Pos is: ", F1Pos)
    F1Neg = (2 * PrecisionNeg * RecallNeg)/(PrecisionNeg + RecallNeg)
    print("F1Neg is: ", F1Neg)
...
def mostUseful(pWordPos, pWordNeg, pWord, n):
    ...
    print ("\nPOSITIVE:")
    print (tail)
    print ("The number of words in sentiment dictionary:", count)
    return(head, tail)
...
print ("Naive Bayes")
#train = testBayes(sentencesTrain,  "Films (Train Data, Naive Bayes)\t", pWordPos, pWordNeg, pWord,0.5)
#test = testBayes(sentencesTest,  "Films  (Test Data, Naive Bayes)\t", pWordPos, pWordNeg, pWord,0.5)
#Nokia = testBayes(sentencesNokia, "Nokia   (All Data,  Naive Bayes)\t", pWordPos, pWordNeg, pWord,0.7)
...
#correct, total, correctpos, totalpospred, totalpos, correctneg, totalnegpred, totalneg = test
#BayesRes(correct, total, correctpos, totalpospred, totalpos, correctneg, totalnegpred, totalneg)
